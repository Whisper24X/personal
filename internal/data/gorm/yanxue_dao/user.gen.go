...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&yanxue_model.User{})

	tableName := _user.userDo.TableName()
	_user.ALL = field.NewAsterisk(tableName)
	_user.ID = field.NewString(tableName, "id")
	_user.Ph = field.NewString(tableName, "ph")
	_user.UserWxID = field.NewString(tableName, "userWxId")
	...
	_user.UserAppointmentInfo = field.NewField(tableName, "userAppointmentInfo")
	_user.ParentInfo = field.NewField(tableName, "parentInfo")
...
type user struct {
	...
	UserWxID            field.String // 用户微信ID
	Nickname            field.String // 昵称
	Avatar              field.String // 头像
	Status              field.Int16  // -1=禁用 1=开启
	CreatedAt           field.Time   // 创建时间
	UpdatedAt           field.Time   // 更新时间
	UserAppointmentInfo field.Field  // 用户预约信息
	ParentInfo          field.Field  // 监护人信息
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserWxID = field.NewString(table, "userWxId")
	...
	u.UserAppointmentInfo = field.NewField(table, "userAppointmentInfo")
	u.ParentInfo = field.NewField(table, "parentInfo")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["id"] = u.ID
	u.fieldMap["ph"] = u.Ph
	u.fieldMap["userWxId"] = u.UserWxID
	u.fieldMap["nickname"] = u.Nickname
	u.fieldMap["avatar"] = u.Avatar
	u.fieldMap["status"] = u.Status
	u.fieldMap["createdAt"] = u.CreatedAt
	u.fieldMap["updatedAt"] = u.UpdatedAt
	u.fieldMap["userAppointmentInfo"] = u.UserAppointmentInfo
	u.fieldMap["parentInfo"] = u.ParentInfo
...
func (u userDo) Create(values ...*yanxue_model.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*yanxue_model.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*yanxue_model.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*yanxue_model.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*yanxue_model.User), nil
	}
}

func (u userDo) Take() (*yanxue_model.User, error) {
...
func (u userDo) Last() (*yanxue_model.User, error) {
...
func (u userDo) Find() ([]*yanxue_model.User, error) {
	result, err := u.DO.Find()
	return result.([]*yanxue_model.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*yanxue_model.User, err error) {
	buf := make([]*yanxue_model.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*yanxue_model.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*yanxue_model.User, error) {
...
func (u userDo) FirstOrCreate() (*yanxue_model.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*yanxue_model.User, count int64, err error) {
...
func (u userDo) Delete(models ...*yanxue_model.User) (result gen.ResultInfo, err error) {
