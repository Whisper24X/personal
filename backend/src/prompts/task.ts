...
// ==================== OpenSpec 提示词 ====================
// Note: OpenSpec workflow prompts have been moved to skills/project-management/SKILL.md
// All OpenSpec-related actions are now executed via ExecuteProjectManagement action
