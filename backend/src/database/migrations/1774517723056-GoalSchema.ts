...
export class GoalSchema1774517723056 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "goal_plan_sub_tasks" DROP CONSTRAINT "FK_goal_plan_sub_tasks_task"`,
    );
    await queryRunner.query(
      `ALTER TABLE "goal_plan_sub_tasks" DROP CONSTRAINT "FK_goal_plan_sub_tasks_item"`,
    );
