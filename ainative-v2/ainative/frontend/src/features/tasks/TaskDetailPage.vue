...
<template>
  <div class="fade-up flex h-full min-h-0 w-full">
    <TaskEnvironmentGate
      ...
      :show-regenerate-runner-config="vm.showRegenerateRunnerConfig"
      :can-regenerate-runner-config="vm.canRegenerateRunnerConfig"
      :regenerate-runner-config-blocked-reason="vm.regenerateRunnerConfigBlockedReason"
      :can-remove="vm.canRemove"
      :regenerate-runner-config-loading="vm.regeneratingRunnerConfig"
      :regenerate-runner-config-preparing="vm.regenerateRunnerConfigPreparing"
      :auto-applying-runner-config="vm.isAutoApplyingRunnerConfig"
      :remove-loading="vm.removingTask"
      :format-date="vm.formatDate"
      @regenerate-runner-config="vm.regenerateRunnerConfig"
    ...
    >
        ...
        <div class="flex min-h-0 w-full flex-1 flex-col gap-2">
          ...
          <div class="flex min-h-0 w-full flex-1 flex-col">
            ...
            <TaskExecutionContextBar
              ...
              :workspace-snapshot-status="vm.environment?.workspaceSnapshotStatus || null"
              :workspace-snapshot-error="vm.environment?.workspaceSnapshotError || null"
              :action-loading="vm.actionLoading"
              :show-regenerate-runner-config="vm.showRegenerateRunnerConfig"
              :can-regenerate-runner-config="vm.canRegenerateRunnerConfig"
              :regenerate-runner-config-blocked-reason="vm.regenerateRunnerConfigBlockedReason"
      ...
      <RightPanelSection
        ...
        :environment-service-statuses="vm.environment?.serviceStatuses || []"
        :format-date="vm.formatDate"
    ...
    <TaskDialogs
      ...
      :delete-block-reason="vm.deleteBlockReason"
