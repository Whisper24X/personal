...
import { buildRouteAccessMeta } from '@shared/constants/access-control'
...
export const systemRoutes: AppRouteRecord[] = [
  ...
  },
  {
    ...
    component: () => import('@pages/business-lines/invite.vue'),
    meta: buildRouteAccessMeta('businessLineInvite'),
  },
  {
    path: '/business-lines',
    name: 'business-lines-manage',
    component: () => import('@pages/business-lines/manage.vue'),
  ...
  },
  {
    ...
    name: 'project-goals',
    component: () => import('@pages/goals/ProjectGoalsList.vue'),
