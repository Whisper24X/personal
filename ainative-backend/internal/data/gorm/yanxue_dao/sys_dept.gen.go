...
func newSysDept(db *gorm.DB, opts ...gen.DOOption) sysDept {
	...
	_sysDept.sysDeptDo.UseModel(&yanxue_model.SysDept{})
	...
	_sysDept.Type = field.NewString(tableName, "type")
...
func (s sysDeptDo) Create(values ...*yanxue_model.SysDept) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysDeptDo) CreateInBatches(values []*yanxue_model.SysDept, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysDeptDo) Save(values ...*yanxue_model.SysDept) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysDeptDo) First() (*yanxue_model.SysDept, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*yanxue_model.SysDept), nil
	}
}

func (s sysDeptDo) Take() (*yanxue_model.SysDept, error) {
...
func (s sysDeptDo) Last() (*yanxue_model.SysDept, error) {
...
func (s sysDeptDo) Find() ([]*yanxue_model.SysDept, error) {
	result, err := s.DO.Find()
	return result.([]*yanxue_model.SysDept), err
}

func (s sysDeptDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*yanxue_model.SysDept, err error) {
	buf := make([]*yanxue_model.SysDept, 0, batchSize)
...
func (s sysDeptDo) FindInBatches(result *[]*yanxue_model.SysDept, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysDeptDo) FirstOrInit() (*yanxue_model.SysDept, error) {
...
func (s sysDeptDo) FirstOrCreate() (*yanxue_model.SysDept, error) {
...
func (s sysDeptDo) FindByPage(offset int, limit int) (result []*yanxue_model.SysDept, count int64, err error) {
...
func (s sysDeptDo) Delete(models ...*yanxue_model.SysDept) (result gen.ResultInfo, err error) {
