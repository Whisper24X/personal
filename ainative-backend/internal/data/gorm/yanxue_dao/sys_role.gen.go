...
func newSysRole(db *gorm.DB, opts ...gen.DOOption) sysRole {
	...
	_sysRole.sysRoleDo.UseModel(&yanxue_model.SysRole{})
	...
	_sysRole.DataPermission = field.NewString(tableName, "dataPermission")
	_sysRole.Status = field.NewInt16(tableName, "status")
	_sysRole.CreatedAt = field.NewField(tableName, "createdAt")
	_sysRole.UpdatedAt = field.NewField(tableName, "updatedAt")
...
func (s *sysRole) updateTableName(table string) *sysRole {
	...
	s.DataPermission = field.NewString(table, "dataPermission")
...
func (s *sysRole) fillFieldMap() {
	...
	s.fieldMap["dataPermission"] = s.DataPermission
...
func (s sysRoleDo) Create(values ...*yanxue_model.SysRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysRoleDo) CreateInBatches(values []*yanxue_model.SysRole, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysRoleDo) Save(values ...*yanxue_model.SysRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysRoleDo) First() (*yanxue_model.SysRole, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*yanxue_model.SysRole), nil
	}
}

func (s sysRoleDo) Take() (*yanxue_model.SysRole, error) {
...
func (s sysRoleDo) Last() (*yanxue_model.SysRole, error) {
...
func (s sysRoleDo) Find() ([]*yanxue_model.SysRole, error) {
	result, err := s.DO.Find()
	return result.([]*yanxue_model.SysRole), err
}

func (s sysRoleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*yanxue_model.SysRole, err error) {
	buf := make([]*yanxue_model.SysRole, 0, batchSize)
...
func (s sysRoleDo) FindInBatches(result *[]*yanxue_model.SysRole, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysRoleDo) FirstOrInit() (*yanxue_model.SysRole, error) {
...
func (s sysRoleDo) FirstOrCreate() (*yanxue_model.SysRole, error) {
...
func (s sysRoleDo) FindByPage(offset int, limit int) (result []*yanxue_model.SysRole, count int64, err error) {
...
func (s sysRoleDo) Delete(models ...*yanxue_model.SysRole) (result gen.ResultInfo, err error) {
