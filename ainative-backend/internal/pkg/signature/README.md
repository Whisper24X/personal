...
基于 HTTP Header 中的两个参数 Authorization、AuthorizationDate、AppKey 存储签名信息。

1. Authorization 存储签名信息，格式：摘要(加密串)，例如： Authorization:MjJjMDE1MWFkZjMwOWFmYjFlNzViNDFjYjYwMWFlMmM=
2. AuthorizationDate 存储时间信息，格式：0000-00-00 00:00:00，使用 Asia/Shanghai 时区，例如；
3. AppKey 调用方的key, 例如：AppKey:123456
