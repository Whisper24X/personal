...
export class Salesperson extends Role {
  constructor(context: Context, name: string = 'Salesperson') {
    const config: IRoleConfig = {
      ...
      constraints:
        'Focus on user needs, market research, target value analysis, requirement value analysis, and business process analysis. Transform user requirements into detailed MRD',
      description:
        'Experienced requirement collection and market research expert who transforms user requirements into comprehensive Market Research Documents (MRD)',
    };
