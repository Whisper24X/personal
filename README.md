...
- 🎨 **HTML 原型自动生成**（集成Cursor Cloud Agent API，从PRD生成HTML原型代码）
...
```bash
# Cursor API Key（用于HTML原型生成功能）
CURSOR_API_KEY=key_5ec9b36ee4704179ee13de83f518d34d235d867bd1182f92c7b062f00fb8fce6
...
#### HTML 原型生成（🆕）
- `POST /api/v1/html-prototype/generate` - 生成 HTML 原型
- `POST /api/v1/html-prototype/generate-from-prd/:prdId` - 从 PRD 生成 HTML 原型
- `GET /api/v1/html-prototype/generate/:taskId/status` - 查询生成状态
- `GET /api/v1/html-prototype/generate/:taskId/conversation` - 获取会话历史
- `POST /api/v1/html-prototype/generate/:taskId/followup` - 发送后续指令
- `POST /api/v1/html-prototype/generate/:taskId/stop` - 停止生成
- `DELETE /api/v1/html-prototype/generate/:taskId` - 删除生成任务
- `GET /api/v1/html-prototype/generate` - 列出所有生成任务

📖 **详细文档**：[HTML原型生成功能说明](doc/HTML_PROTOTYPE_GENERATION.md) | [快速开始指南](doc/QUICKSTART_HTML_PROTOTYPE.md)
