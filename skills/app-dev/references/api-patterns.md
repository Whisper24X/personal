...
```typescript
// src/api/request.ts
const NO_TOKEN_WHITELIST: string[] = ['/api/v1/auth/login', '/api/v1/auth/register', '/api/v1/public/config'];
```
...
```typescript
const UNAUTHORIZED_WHITELIST: string[] = ['/api/v1/user/check-login', '/api/v1/token/validate'];
```
