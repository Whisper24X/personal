module gitlab.yc345.tv/backend/devices-learn
...
require (
	...
	gitlab.yc345.tv/backend/orm-gen/v2 v2.0.7
	gitlab.yc345.tv/backend/utils/v2 v2.13.0
	gitlab.yc345.tv/security-and-payment/tracing v1.1.2
