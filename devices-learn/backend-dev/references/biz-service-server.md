...
type ProductRepo interface {
    studyspace_service_repo.IProductRepo
    DTO(product *studyspace_service_model.Product) *pb.ProductInfo
}
```
...
优先使用 `internal/data/gorm/studyspace_service_repo` 中已有生成方法。不要为了转发生成方法再封装一层。
